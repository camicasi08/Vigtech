...
urlpatterns=patterns('',
	...
	url(r'^gestionproyectos/nuevoProyecto/$', 'principal.views.nuevo_proyecto', name='crear_proyecto'),
	url(r'^gestionproyectos/MisProyectos/$', 'principal.views.ver_mis_proyectos', name='ver_mis_proyectos'),
	url(r'^gestionproyectos/editar_proyecto/(\d+)$','principal.views.editar_proyecto', name='editar_proyecto'),
	url(r'^gestionproyectos/ver_proyecto/(\d+)$', 'principal.views.ver_proyecto', name='ver_proyecto'),
